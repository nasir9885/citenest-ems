  ...
  async function loadPayroll() {
    ...
    try {
      const response = await fetch(
        `/api/ems/salary?month=${month}&year=${year}`,
        {
          cache: "no-store",
        }
      );
      ...
      const rows = result.employees.map(
        (employee: PayrollEmployee) => ({
          ...
          basic_salary:
            ...
            employee.employee_basic_salary,
          ...
          payment_date:
            employee.payment_date
              ? employee.payment_date.substring(
                  0,
                  10
                )
              : "",
      ...
      <header className="ems-header">
        <div className="ems-container ems-nav">
          ...
          <div className="ems-language-switch">
            <Link href="/ems/en/salary">
              English
            </Link>

            <Link href="/ems/ar/salary">
              العربية
            </Link>
          </div>
        </div>
